...
public class RecyclerFragmentCenterList extends Fragment implements RecyclerRefreshManager, RecyclerClickManager {

    //Extra key
    private final static String CENTERS_EXTRA = "centersExtra";

    public static RecyclerFragmentCenterList newInstance(ArrayList<Center> centers) {
        RecyclerFragmentCenterList recyclerFragmentCenterList = new RecyclerFragmentCenterList();
        Bundle args = new Bundle();
        args.putParcelableArrayList(CENTERS_EXTRA, centers);
        recyclerFragmentCenterList.setArguments(args);
        return recyclerFragmentCenterList;
    }
